...
def fail_req_config_missing(opt_name):
    raise Exception(
        ...
        "for dlrn.drivers.downstreamdeps driver." % opt_name)


class DownstreamDepsInfoDriver(PkgInfoDriver):
    DRIVER_CONFIG = {
        'downstream_driver': {
    ...
    def __init__(self, *args, **kwargs):
        super(DownstreamDepsInfoDriver, self).__init__(*args, **kwargs)
    ...
    def getpackages(self, **kwargs):
        ...
        if not info_files:
            fail_req_config_missing('info_files')
